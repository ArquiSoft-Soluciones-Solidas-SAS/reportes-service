...
SECRET_KEY = 'django-insecure-1!h%+xjv7x9g1t94)cz9(8on!)-y+s+u&c)4pis)6rt%%+vc6k'
...
MONGODB_DATABASES = {
    "default": {
        "name": 'reportes-query-service',
        "host": 'mongodb://microservicios_user:password@10.128.0.87:27017',
        "tz_aware": True, # if you using timezones in django (USE_TZ = True)
    },
}

mongoengine.connect(
    db="reportes-query-service",
    host="mongodb://microservicios_user:password@10.128.0.87:27017",
...
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "https://dev-73advmhx411p43vz.us.auth0.com/v2/logout?returnTo=http%3A%2F%2F10.142.0.11:8080"
